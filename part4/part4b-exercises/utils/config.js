...
// But before the options add your appName, e.g. (without admin/pw) add the 'blogApp' in between:
// MONGODB_URI=mongodb+srv://****:*********@cluster0.***.mongodb.net/blogApp?retryWrites=true&w=majority
